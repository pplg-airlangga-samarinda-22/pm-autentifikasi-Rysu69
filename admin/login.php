...
if (isset($_SESSION['role']) && ($_SESSION['role'] == 'petugas' || $_SESSION['role'] == 'admin')) {
    ...
    $redirect_page = $_SESSION['role'] == 'admin' ? "dashboard.php" : "../petugas/dashboard.php";
    header("Location: $redirect_page");
    exit;
}

// Handle petugas login form submission
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result_petugas->num_rows > 0) {
        ...
        $_SESSION['role'] = $user['level']; // 'admin' or 'petugas'
        $redirect_page = $user['level'] == 'admin' ? "dashboard.php" : "../petugas/dashboard.php";
        header("Location: $redirect_page");
        exit;
    } else {
...
<body class="bg-gray-100">
    <div class="flex justify-center items-center h-screen">
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
            <h1 class="text-2xl font-bold text-center mb-6">Petugas Login</h1>
            ...
            <form method="POST" action="" class="space-y-4">
                ...
                Login
                <a href="../masyarakat/login.php" class="text-blue-500 underline">masyarakat</a>
            </p>
            </form>
        </div>
    </div>
